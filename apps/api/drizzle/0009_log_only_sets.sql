...
ALTER TABLE "workout_sets" ADD CONSTRAINT "workout_sets_engine_provenance_check" CHECK (("workout_sets"."mode" IS DISTINCT FROM 'engine' AND "workout_sets"."avg_form_score" IS NULL
           AND "workout_sets"."rep_scores" IS NULL AND "workout_sets"."fault_counts" = '{}'::jsonb)
