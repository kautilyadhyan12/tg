...
export const ACHIEVEMENTS: readonly AchievementSeed[] = [
  ...
  { code: "streak_3", nameKey: "achievement.streak_3", icon: "🔥", criteria: { stat: "current_streak", gte: 3 } },
  { code: "streak_7", nameKey: "achievement.streak_7", icon: "🔥", criteria: { stat: "current_streak", gte: 7 } },
  { code: "streak_30", nameKey: "achievement.streak_30", icon: "🔥", criteria: { stat: "current_streak", gte: 30 } },
  { code: "streak_100", nameKey: "achievement.streak_100", icon: "💎", criteria: { stat: "current_streak", gte: 100 } },
  ...
  { code: "calorie_1k", nameKey: "achievement.calorie_1k", icon: "⚡", criteria: { stat: "total_kcal", gte: 1000 } },
  { code: "calorie_10k", nameKey: "achievement.calorie_10k", icon: "🌋", criteria: { stat: "total_kcal", gte: 10000 } },
  ...
  { code: "variety_5", nameKey: "achievement.variety_5", icon: "🎭", criteria: { stat: "families_tried", gte: 5 } },
