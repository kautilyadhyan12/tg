...
describe("decideSend — every class of case", () => {
  const cases: [string, Partial<SendFacts>, ReturnType<typeof decideSend>][] = [
    ...
    ["the invitation was withdrawn", { inviteState: "withdrawn" }, { kind: "skip", reason: "invitation_withdrawn" }],
    ["withdrawn, and the address off the list too", { inviteState: "withdrawn", onList: false }, { kind: "skip", reason: "invitation_withdrawn" }],
    ...
    ["everyone on the list at the address is under 18", { onlyUnderAge: true }, { kind: "skip", reason: "under_age" }],
    ["under 18 and in the app", { onlyUnderAge: true, inApp: true }, { kind: "skip", reason: "under_age" }],
    ["under 18, with no domain asked", { onlyUnderAge: true, mail: null }, { kind: "skip", reason: "under_age" }],
