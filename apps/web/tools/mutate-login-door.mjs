...
const MUTANTS = [
  ...
  },
  {
    ...
    from: '  return <Navigate to={landingRoute(user, readDoor(), readJoinCode())} replace />;',
  ...
  },
  {
    ...
    expect: 'takes the Manage door to the console',
    from: '      const dest = landingRoute(res.user, door, joinCode);',
    to: '      const dest = landingRoute(res.user, null, joinCode);',
  },
  {
    id: 'D9',
    target: 'login',
    ...
    expect: 'offers Train and Manage',
    from: "  { value: GYM_DOOR,    label: 'Manage my gym, studio or clients' },\n",
    to: '',
  },
  {
    id: 'D10',
    ...
    from: '  return landingRoute(user, door, joinCode);',
    to: "  return '/dashboard';",
  },
  {
    id: 'D11',
