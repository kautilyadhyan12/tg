      ...
      <div className="max-w-2xl mx-auto px-6 space-y-6">
        ...
        >
          {[
            ...
            { icon: Flame,    label: 'Calories',  value: `${orUnknown(summary.caloriesBurned)} kcal`, color: 'text-orange-400',   bg: 'bg-orange-500/10', sublabel: 'Estimate', sublabelTip: 'Calculated from your body weight using standard MET values: the time you spent actually working at the exercise’s own rate, and your standing-around and rest-break time at a low resting rate. Time while you were paused is not counted at all. Not measured by a heart-rate sensor, so treat it as a planning estimate rather than an exact figure.' },
