...
2. [ ] **Organisation types** gym · studio · personal trainer at creation; a new owner from the "Manage" door lands on "create your organisation" with no personal onboarding. *Built 2026-09-08 (branch `organisation-types`); awaiting review and Kd's click-through.*
   - 2b. [ ] **Console words by type.** Every console screen says Clients / Sessions / Coach for a studio or a trainer where it says Members / Workouts / Trainer for a gym (spec Part 3 §2.2). Only the create screen, the front door and the join-code card speak a trainer's words today.
