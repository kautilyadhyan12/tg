...
2. **Organisation types** (split 2026-09-08).
   - 2a. [ ] **Types at creation.** Gym · studio · personal trainer; a new owner from the "Manage" door lands on "create your organisation" with no personal onboarding. *Built 2026-09-08 (branch `organisation-types`); Kd clicked through; review round 1 fixed.*
