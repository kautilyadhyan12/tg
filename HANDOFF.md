...
- Pre-existing and NOT this diff: `apps/web/src/hooks/poseAssets.contract.test.js` fails to parse on this machine (valid UTF-8, unmodified since 2026-08-18, imports nothing of this card); the rest of the web suite is 2,158 passed. CI runs web tests on Linux and was green at the last merge.
