...
- **Next: the review round.** `reviews/3a-v-a-1-review.md` is written and waiting; Kd opens a FRESH terminal in Folder A and types `Review reviews/3a-v-a-1-review.md`. PR #90 is open and not merged — Kd has not said "merge", and the ROADMAP line's merge date assumes today. Then 3a-v-b (keeping it: one migration, the reconcile rule over the wider row, former records, the filters). The four dashboard images on disk are still nobody's.
