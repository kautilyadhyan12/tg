...
- Next: **Part 8, the phone app, the two folders and the dates** — put to Kd in simple words with honest estimates, then written down; then the start texts for the two folders.
