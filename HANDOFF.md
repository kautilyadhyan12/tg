...
- Next: **the re-check of THIS round goes back to that same reviewer chat** (CLAUDE.md §6), never a fresh one. Then Kd's word to merge PR #88, then 3a-iv, after which the two extra passes run once over the whole member-list feature.
