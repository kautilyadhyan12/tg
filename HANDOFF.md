...
- **Next**: Kd's click-through, then the round-one review (`reviews/17b-ii-a-1-review.md`), then merge on his word. The four dashboard images on disk are still nobody's.
