...
- Open: the Google Sheets pair (Kd downloads it; the steps are in this chat) joins the fixtures before review · review round one in a fresh chat that RUNS the bombs (CLAUDE.md §6) · 3a-ii next. The four dashboard images are still not this card's.
