...
- **Verified**: api tsc 0 · api eslint 0 · shared tsc 0 · shared eslint 0 · shared 220/220 · results unit and invite unit 254/254 · results routes 23/23 · full api suite on local Postgres 105 files, 3,278 passed, 0 failed · web: `console.render` and `nutritionChangeLogged.render` each failed once in the full run under load and passed alone (132/132); `poseAssets.contract` fails locally on Node 24 only, as before. No harness targets a file this job changed.
