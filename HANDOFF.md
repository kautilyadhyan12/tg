...
- **Kd decided one thing (RULINGS 2026-09-22)**: who counts as the same person does not change, so a gym that corrects a spelling leaves a FORMER record beside the new one — put to him with its alternative and the recommendation, and *"go"*. The case to settle is the person's page (3a-iv). **PR #91 is open and NOT merged** — he has not said "merge". Round one's review file is `reviews/3a-v-b-1-review.md`. Then 3a-iv. The four dashboard images on disk are still nobody's.
