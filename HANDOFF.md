...
- **Open**: a slot's "Next:" dates start at the gym's today, so a class earlier today is listed after it ran — server, pre-existing, added to 17b-ii-b-ii. The re-check, then Kd's "merge" and the ROADMAP tick.
