...
- Next: the same reviewer chat re-checks the fixes; then Kd's click-through, merge on his word. Then 7a-iv-g and 7a-iv-h (order Kd's), then the member list. The four dashboard images are still not this card's.
