...
- Next: **Part 7, messages and reports** — automatic emails, why SMS waits (US rules register the SENDER, and a sole proprietor outside the US and Canada cannot register that way), low-attendance alerts, and the money and attendance reports — then Part 8, the phone app, the two folders and the dates.
