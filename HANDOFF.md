...
- `aihg_b` carries `0041` (its ledger hash re-set after a same-day edit). Folder A's `join-invitation` has `0040` stamped …023; this is …024, so if 1a merges FIRST, Folder A re-stamps its `0040` after …024 (CLAUDE.md §8).
