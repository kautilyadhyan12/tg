...
- **The limits, the chat's call in the plan** (RULINGS 2026-09-23): 12 time slots of a class running on any one day (`peakRunning`, table-tested), and 24 listed; the Classes read is sized on 24. Round one's L-1 test of 17b-ii-b-ii-a now meets the 24-listed limit (23 moves, then 409) where it met 12.
