...
- Next: **Part 2, the member record** — keeping everything in a gym's file (plan, dates, payment status, its own columns), how real gym software lays a member out, migration made easy — put to Kd as a plan, then written down.
