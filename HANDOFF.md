...
- Next: Kd's click-through on the local API and web, merge on his word. Then 7a-iv-g and 7a-iv-h (order Kd's), then the member list. The four dashboard images are still not this card's.
