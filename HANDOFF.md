...
- Next: Kd's word to merge PR #85 (CI green on the merge commit's parent). "Paste rows" for item 5 still unanswered, then 3a-ii. The four dashboard images are still not this card's.
