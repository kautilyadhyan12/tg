...
- **Open**: review round one (`reviews/3b-ii-a-1-review.md`, not started). 3b-i-b's "two workers at once" test failed four CI runs and passed two, never locally (ROADMAP 10); `42b826f` makes a failure print each report's state and each run's outcome, and that run passed. Next in Folder A: 3b-ii-b.
