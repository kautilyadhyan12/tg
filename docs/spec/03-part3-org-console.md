...
- "Remove all" sent again with the same numbers (a retry, or the second of two staff) answers 200 `alreadyRemoved: true` with what the first press removed: the summary audit row keeps the set's digest for a day.
