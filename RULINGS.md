...
- 2026-09-11 · Screen 1, from 4a-iv's click-through: ONE heading, "Your goal", over one grid three to a row — the weight choices are the top row, the goals below — with no second question and no hint lines; a ninth goal, **Stay healthy**, evens the rows; "A gym" loses "(everything there)". *"no seperate things needed all together and heading your goal men"* · *"a gym the bracket everything there not needed"*
